        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="mb-2 d-flex">
                    ...
                    <div class="col-auto flex-grow-1 return_date"><?php echo !is_null($due_date) ? date("F d, Y",strtotime($due_date)) : "N/A" ?></div>
                    <span><a href="javascript:void(0)" class="text-dark btn-light fs-6 text-decoration-none update_due" data-due="<?php echo $due_date ?>"><i class="fa fa-edit"></i> Update</a></span>
                </div>
            </div>
        </div>
        <div class="row">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="w-100 d-flex">
                                    <div class="col-auto flex-grow-1">
                                        <div><a class="fs-5 text-decoration-none view_book" href="javascript:void(0)" data-id="<?php echo $row['book_id'] ?>"><b><?php echo $row['title'] ?></b></a>
                                        </div>
                                        <div class='lh-1'>
...
<script>
    $(function(){
        $('.view_book').click(function(){
            uni_modal('Book Details',"view_book.php?borrowed_id=<?php echo $borrowed_id ?>&id="+$(this).attr('data-id'),"mid-large")
        })
        $('.update_status').click(function(){
            uni_modal_secondary('Update Status',"update_borrowed_status.php?id=<?php echo $borrowed_id ?>&status="+$(this).attr('data-status'))
        })
        $('.update_due').click(function(){
            uni_modal_secondary('Update Returning Date',"update_borrowed_due.php?id=<?php echo $borrowed_id ?>&due="+$(this).attr('data-due'))
        })
    })
</script>