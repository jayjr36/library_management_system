                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="sub_category_id" id="sub_category_id" class="form-select form-select-sm rounded-0" required>
                            <option <?php echo (!isset($sub_category_id)) ? 'selected' : '' ?> disabled>Please Select Category</option>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <?php if(isset($book_id)): ?>
                            <small class="text-info"><i>Upload Only if you wish to update the book thumbnail.</i></small>
                        <?php endif; ?>
                    </div>
                    <div class="form-group">
                        ...
                        <?php if(isset($book_id)): ?>
                            <small class="text-info"><i>Upload Only if you wish to add book images.</i></small>
                        <?php endif; ?>
                    </div>
                    <div class="form-group">
