...
<?php endwhile; ?>
            ...
            <hr>
            <div class="list-group">
                <a href="./?category=<?php echo $_GET['category'] ?>" class="list-group-item <?php echo !isset($_GET['sub_category']) || (isset($_GET['sub_category']) && !is_numeric($_GET['sub_category']))? "active" : "" ?>">All</a>
                <?php 
            ...
            <div class="row">
                <div class="form-group">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Search Here" aria-label="Search Here" id="search" value="<?php echo isset($_GET['search']) ? $_GET['search'] : '' ?>" aria-describedby="btn-search">
                        <button class="btn btn-outline-secondary" type="button" id="btn-search"><i class="fa fa-search"></i> Search</button>
                    </div>
                </div>
            </div>
