...
<head>
    ...
    <title><?php echo ucwords(str_replace('_','',$page)) ?> | Simple OPAC</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <?php 
                         $count = $conn->query("SELECT count(book_id) as total FROM `cart_list` where `user_id` = '{$_SESSION['user_id']}'")->fetch_assoc()['total'];
                        ?>
