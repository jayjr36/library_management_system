    ...
    <div class="col-12">
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <div><span class="text-muted">Written by: </span><?php echo $author ?></div>
                <div class="lh-1">
                        <small><i><span class="text-muted">Category: </span><?php echo $category ?></i></small><br>
                        <small><i><span class="text-muted">Sub Category: </span><?php echo $sub_category ?></i></small>
                    </div>
                ...
                $.ajax({
                    ...
                    success:function(resp){
                        if(resp.status == "success"){
                            ...
                            alert("Book/Material Added to cart");
